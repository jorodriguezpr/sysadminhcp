...
<VirtualHost *:443>
    ...
    # webmail.<domain> silently got this box's generic self-signed cert instead. ServerName alone
    # still answers a direct https://webmail/ hit for local/no-SNI-match fallback traffic.
    ServerName webmail
