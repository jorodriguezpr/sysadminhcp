...
<center>
  <form action="<?php print ''; ?>" method="POST" onSubmit="return CheckFormSendEmail(this)">
  <table width="750" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      <td colspan="2"><br>
      <?php print_notify_users( $from , $emailText, $subject ); ?>
      <br></td>
    </tr>
    <tr> 
    </tbody> 
  </table>
  <br><i><a href="http://qmailtoaster.com" target="_blank">Qmail Toaster &copy 2004-2019</a></i><br>
</form>
</center>
</body></html>
